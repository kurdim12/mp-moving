...
export const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    category: "Brand & Digital Identity",
    year: "2025",
    tagline: "Brand Rebirth.",
    descriptor: "Brand Rebirth · Corporate & Destination Events",
    microSignal: "Brand alignment",
    initials: "MN",
    context:
      "MaraNasi was operating in the corporate and destination events space across Jordan and international markets. The brand had experience, but the identity and digital presence did not reflect its scale, precision, or ambition. The visual language lacked authority. The website lacked narrative structure. The positioning lacked clarity. This was not a redesign. This was a controlled rebirth.",
    tags: ["Brand Identity Facelift", "Logo Refinement", "Website Redesign", "Positioning Shift"],
    process:
      "We refined the logo without breaking brand recognition — improving proportions, increasing typographic strength, removing visual noise, and elevating brand tone from decorative to authoritative. The goal was clarity, not ornament. We restructured the website from brochure-style pages to a system-driven corporate experience: clear corporate segmentation, strategic messaging hierarchy, clean typography with intentional whitespace, and premium minimal UI aligned with high-value clients. Every section was rewritten and reorganized to communicate control, scale, and reliability.",
    modules: [
      { name: "Logo Facelift", description: "Refined identity without breaking recognition — improved proportions, typographic strength, elevated tone from decorative to authoritative.", deliverable: "Refined logo system" },
      { name: "Website Transformation", description: "From brochure-style pages to a system-driven corporate experience with strategic messaging hierarchy and premium minimal UI.", deliverable: "Full website redesign" },
      { name: "Strategic Positioning", description: "Restructured messaging around operational control, international readiness, and high-value execution.", deliverable: "Positioning framework" },
    ],
    impactStatements: ["Elevated from event organizer to structured corporate experience partner", "Brand now communicates operational control and international readiness", "Visual language and digital structure aligned — perception shifted instantly"],
    deliverables: ["Logo refinement", "Brand guidelines", "Full website redesign", "Corporate segmentation", "Positioning framework"],
    founderQuote: "When brand language and digital structure align, perception shifts instantly.",
    founderName: "Founder",
